{% macro reusable_js_s3_redshift_copy_withdynamicschema_new_api_new(target_dataset_name, target_table_name, source_dataset_name, source_table_name, is_delete=1) %}
    {#
