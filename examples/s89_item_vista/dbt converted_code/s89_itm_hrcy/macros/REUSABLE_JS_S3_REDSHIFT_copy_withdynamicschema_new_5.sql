{% macro REUSABLE_JS_S3_REDSHIFT_copy_withdynamicschema_new_API_5(target_dataset_name, target_table_name, source_dataset_name, source_table_name, is_delete=1) %}
    {#
